...
export default function ExpoPage() {
  ...
  const [components, setComponents] = useState<string[]>(globalApps);
  ...
  const handleFileSelect = useCallback(
    async (event: React.ChangeEvent<HTMLInputElement>) => {
      ...
      try {
        // Detect framework (should be Expo)
        ...
        if (detectedFramework) {
          ...
          // Detect components if framework supports it
          if (detectedFramework.appDetector) {
            const detectedComponents = await detectedFramework.appDetector(
              files
            );
            setComponents(detectedComponents);
            setGlobalApps(detectedComponents);
          }
        }
      } catch (error) {
      ...
      if (selectedFiles) {
        ...
        try {
          ...
          if (newFramework.appDetector) {
            const detectedComponents = await newFramework.appDetector(
              selectedFiles
            );
            setComponents(detectedComponents);
            setGlobalApps(detectedComponents);
  ...
  }, [framework, processedFiles, projectName, components]);
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center">
            ...
            <div className="flex items-center">
              <div className="bg-gradient-to-r from-purple-500 to-pink-600 p-2 rounded-lg shadow-md mr-3">
                <Code className="h-6 w-6 text-white" />
              </div>
              <div>
                <h1 className="text-2xl font-bold text-gray-900">
                  Expo Project Analyzer
                </h1>
                <p className="text-gray-600">
                  📱 Universal React Native platform
                </p>
              </div>
            </div>
          </div>
            ...
            >
              <div className="text-center mb-6">
                ...
                <h2 className="text-xl font-semibold text-gray-900 mb-2">
                  Upload Your Expo Project
                </h2>
                <p className="text-gray-600">
                  Select your project folder to analyze the structure and
                  generate context
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <label
                    ...
                    className="block w-full p-4 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-purple-400 hover:bg-purple-50 transition-colors"
                  >
                    <div className="text-center">
                      ...
                      <p className="text-sm text-gray-500 mt-1">
                        Click to select your Expo project directory
                      </p>
                    </div>
                  </label>
                </div>
              ...
              <div className="mt-6 p-4 bg-purple-50 rounded-lg">
                ...
                <ul className="text-sm text-purple-800 space-y-1">
                  <li>• Expo configuration files (expo.json, app.json)</li>
                  <li>• Main app entry point (App.js/tsx)</li>
                  <li>• Screen components and navigation</li>
                  <li>• React Native components</li>
                  <li>• Assets and constants</li>
                  <li>• Services and API integrations</li>
                </ul>
              </div>
            </div>
          </div>
              ...
              <button
                ...
                className={`w-full py-4 px-6 rounded-xl font-semibold text-white transition-all duration-200 shadow-lg ${
                  isProcessing || selectedCount === 0 || !framework
                    ...
                    : "bg-purple-500 hover:bg-purple-600 hover:shadow-xl transform hover:-translate-y-0.5"
                }`}
              >
